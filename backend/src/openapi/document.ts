...
export const openApiDocument = {
  ...
  components: {
    ...
    schemas: {
      ...
      ComplaintTrackingRequest: { type: 'object', required: ['ticketNumber', 'referenceNumber', 'consumerId'], properties: { ticketNumber: { type: 'string', pattern: '^MEPCO-[0-9]{4}-[0-9]{6}$' }, referenceNumber: { $ref: '#/components/schemas/ConsumerReferenceNumber' }, consumerId: { $ref: '#/components/schemas/ConsumerId' } } },
