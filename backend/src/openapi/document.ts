...
export const openApiDocument = {
  ...
  paths: {
    ...
    '/api/v1/tickets': { get: operation('Tickets', 'List and filter tickets within the actor scope'), post: operation('Tickets', 'Submit a requester ticket idempotently', { body: true, created: true }) },
    '/api/v1/tickets/{id}': { get: operation('Tickets', 'Get scoped ticket detail, comments, files, and history', { parameters: [idParameter] }) },
