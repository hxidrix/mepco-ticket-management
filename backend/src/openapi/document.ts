...
export const openApiDocument = {
  ...
  components: {
    ...
    schemas: {
      ...
      EmployeeRegistrationRequest: { type: 'object', required: ['employeeId', 'name', 'email', 'phone', 'cnic', 'password', 'departmentId', 'designation', 'circleId', 'divisionId', 'subdivisionId'], properties: { employeeId: { $ref: '#/components/schemas/EmployeeIdInput' }, name: { type: 'string' }, email: { type: 'string', format: 'email' }, phone: { $ref: '#/components/schemas/PhoneNumber' }, cnic: { $ref: '#/components/schemas/Cnic' }, password: { type: 'string', format: 'password' }, departmentId: { type: 'integer', minimum: 1 }, designation: { type: 'string' }, circleId: { type: 'integer', minimum: 1 }, divisionId: { type: 'integer', minimum: 1 }, subdivisionId: { type: 'integer', minimum: 1 } } },
